...
**BSTU-AI** — дипломный проект, представляющий систему умного помощника для студентов БГТУ. Архитектура построена на специализированных агентах, каждый из которых отвечает за свою область: учёба, расписание и академическая информация.
